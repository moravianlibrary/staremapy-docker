...
def transformData(header, data):
    ...
    data[geoid_index] = 'http://staremapy.georeferencer.cz/map/%s/visualize' % (geoid)
...
query = "SELECT 'title', 'georeferencer_id', 'collection' FROM 1gpUBes9cpOkH3h-fNyS_4dnuLelIY-bSuWdNfqw WHERE 'status' = 'georeferenced'"
